    ...
    <div className="p-4 md:p-10">
      ...
      <div className="space-y-8">
          ...
          {user && (
            <div className="flex gap-2 flex-shrink-0">
              ...
              <Button asChild variant="secondary">
                  <Link href="/groupprojects/create">Create a Group Project</Link>
              </Button>
            </div>
          )}
        </div>
        ...
        <div className="relative">
          ...
          <Input 
            placeholder="Search by project name or topic..."
            className="pl-10"
            value={searchTerm}
        ...
        <section className="space-y-4">
          ...
          {!isLoading && filteredGroupProjects.newGroupProjects && filteredGroupProjects.newGroupProjects.length > 0 ? (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
             ...
             !isLoading && <p className="text-muted-foreground">No new group projects at this time.</p>
          )}
        </section>
        ...
        <section className="space-y-4">
          ...
          {!isLoading && filteredGroupProjects.inProgressGroupProjects && filteredGroupProjects.inProgressGroupProjects.length > 0 ? (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
             ...
             !isLoading && <p className="text-muted-foreground">No in-progress group projects at this time.</p>
          )}
        </section>
      </div>
    </div>
